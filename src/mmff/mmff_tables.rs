...
#[rustfmt::skip]
pub const MMFF_ANGLE_TABLE: [(u8, u8, u8, u8, f64, f64); 2373 + 10 + 23 + 1 + 4 + 3 + 1 + 17 + 3 + 1] = [
    (0, 0, 1, 0, 0.0, 108.9),
    ...
    (0, 1, 1, 8, 0.777, 108.29),
    (0, 1, 1, 9, 1.136, 108.194),
    (0, 1, 1, 10, 1.05, 109.96),
    (0, 1, 1, 11, 1.225, 108.313),
    (0, 1, 1, 12, 1.056, 108.679),
    (0, 1, 1, 13, 1.078, 106.82),
    (0, 1, 1, 14, 0.98, 109.945),
    ...
    (0, 1, 1, 39, 0.927, 109.17),
    (0, 1, 1, 40, 1.13, 108.678),
    (0, 1, 1, 41, 0.33, 98.422),
    (0, 1, 1, 43, 1.135, 108.019),
    (0, 1, 1, 45, 1.197, 105.028),
    (0, 1, 1, 54, 1.173, 106.424),
    (0, 1, 1, 55, 1.15, 107.604),
    (0, 1, 1, 56, 1.199, 110.371),
    (0, 1, 1, 57, 1.012, 109.9),
    ...
    (0, 1, 1, 73, 1.16, 104.658),
    (0, 1, 1, 78, 1.012, 109.85),
    ...
    (0, 3, 1, 18, 1.12, 108.119),
    (0, 3, 1, 20, 0.969, 111.83),
    ...
    (0, 5, 1, 19, 0.45, 113.195),
    (0, 5, 1, 20, 0.706, 111.0),
    (0, 5, 1, 22, 0.618, 110.38),
    ...
    (0, 5, 1, 57, 0.626, 110.42),
    (0, 5, 1, 58, 0.75, 105.481),
    (0, 5, 1, 61, 0.71, 109.227),
    ...
    (0, 11, 18, 11, 1.6671171151987656, 104.600),
    ...
    (0, 12, 1, 37, 1.076, 109.03),
    (0, 12, 1, 39, 1.15, 110.359),
    (0, 12, 1, 45, 1.353, 101.43),
    ...
    (0, 22, 1, 22, 0.99, 111.226),
    (0, 22, 1, 25, 0.885, 107.293),
    (0, 22, 1, 34, 1.045, 112.94),
    ...
    (1, 2, 2, 39, 0.976, 122.36),
    (0, 2, 2, 40, 0.773, 126.83),
    ...
    (0, 5, 2, 55, 0.651, 116.0),
    (0, 5, 2, 62, 0.568, 125.344),
    (1, 5, 2, 63, 0.55, 120.0),
    (1, 5, 2, 64, 0.546, 120.0),
    (0, 5, 2, 72, 0.531, 122.009),
    (1, 5, 2, 81, 0.665, 115.0),
    (1, 6, 2, 9, 1.214, 120.52),
    (0, 6, 2, 10, 1.311, 115.921),
    (0, 6, 2, 22, 1.08, 120.56),
    ...
    (0, 10, 2, 41, 0.951, 120.0),
    (0, 12, 2, 12, 1.012, 119.105),
    (0, 12, 2, 17, 1.11, 114.206),
    ...
    (0, 1, 3, 5, 0.808, 117.28),
    (0, 1, 3, 6, 1.043, 109.716),
    (0, 1, 3, 7, 0.938, 124.41),
    ...
    (0, 28, 10, 28, 0.435, 115.63),
    (0, 28, 10, 34, 0.757, 113.0),
    (0, 28, 10, 35, 0.836, 114.0),
    (0, 28, 10, 37, 0.628, 118.227),
    (0, 28, 10, 40, 0.754, 113.0),
    (0, 28, 10, 41, 0.56, 128.067),
    (0, 28, 10, 63, 0.64, 118.099),
    ...
    (0, 32, 18, 37, 1.497, 105.28),
    (0, 32, 18, 39, 1.804, 101.6),
    ...
    (0, 32, 18, 80, 1.4, 110.401),
    (0, 37, 18, 37, 1.157, 104.38),
    (0, 37, 18, 39, 1.404, 99.854),
    (0, 37, 18, 43, 1.416, 99.2),
    (0, 37, 18, 48, 1.33, 104.466),
    ...
    (0, 1, 20, 3, 0.906, 114.94),
    (0, 1, 20, 5, 0.417, 114.057),
    (0, 1, 20, 6, 1.231, 110.677),
    (0, 1, 20, 8, 1.08, 111.09),
    (0, 1, 20, 10, 1.1, 110.057),
    ...
    (0, 9, 20, 20, 1.103, 109.64),
    (0, 10, 20, 15, 1.17, 109.525),
    (0, 10, 20, 17, 1.127, 110.564),
    (0, 10, 20, 18, 1.404, 100.845),
    (0, 10, 20, 20, 1.032, 113.17),
    (4, 10, 20, 20, 1.468, 87.497),
    (4, 10, 20, 30, 1.507, 86.657),
    (0, 10, 20, 37, 0.963, 117.36),
    (0, 11, 20, 11, 1.504, 108.02),
    (0, 11, 20, 17, 1.221, 109.46),
    (0, 11, 20, 20, 1.051, 116.673),
    (0, 11, 20, 30, 0.997, 120.309),
    (0, 12, 20, 12, 1.02, 117.603),
    ...
    (0, 15, 20, 30, 0.96, 115.468),
    (4, 15, 20, 30, 1.447, 86.726),
    (4, 17, 20, 17, 1.309, 94.977),
    (0, 17, 20, 20, 0.93, 116.108),
    (0, 18, 20, 20, 1.007, 113.48),
    ...
    (0, 3, 22, 10, 0.987, 117.75),
    (0, 3, 22, 12, 0.93, 118.047),
    ...
    (0, 20, 22, 22, 0.812, 122.43),
    (4, 20, 22, 22, 1.198, 92.93),
    (0, 22, 22, 22, 0.787, 124.07),
    (3, 22, 22, 22, 0.171, 60.0),
    ...
    (0, 2, 30, 22, 0.737, 131.1),
    (1, 2, 30, 30, 0.751, 132.225),
    (1, 3, 30, 4, 0.721, 134.566),
    (1, 3, 30, 5, 0.41, 135.975),
    (1, 3, 30, 6, 0.845, 137.596),
    (1, 3, 30, 20, 0.714, 130.677),
    (7, 3, 30, 20, 1.28, 89.957),
    (1, 3, 30, 30, 0.857, 122.418),
    (7, 3, 30, 30, 1.26, 93.102),
    (0, 4, 30, 20, 0.69, 136.444),
    (0, 5, 30, 20, 0.39, 131.835),
    ...
    (1, 2, 37, 38, 1.029, 117.22),
    (1, 3, 37, 37, 0.798, 114.475),
    (7, 3, 37, 37, 1.32, 90.784),
    ...
    (1, 38, 37, 63, 1.076, 114.91),
    (0, 38, 37, 64, 1.07, 116.605),
    (1, 38, 37, 67, 1.289, 109.61),
    ...
    (1, 63, 39, 65, 1.146, 117.99),
    (0, 63, 39, 78, 1.3, 105.8),
    ...
    (0, 1, 40, 10, 1.232, 111.32),
    (0, 1, 40, 11, 1.436, 104.665),
    (0, 1, 40, 12, 1.202, 109.32),
    (0, 1, 40, 20, 1.047, 114.97),
    ...
    (0, 0, 51, 0, 0.0, 111.4),
    (0, 3, 51, 52, 0.913, 111.36),
    (0, 0, 53, 0, 0.0, 180.0),
    (0, 3, 53, 47, 0.574, 180.0),
    (0, 9, 53, 47, 0.649, 180.0),
    (0, 0, 54, 0, 0.0, 119.5),
    (1, 0, 54, 0, 0.0, 115.7),
    ...
    (0, 6, 54, 36, 0.826, 115.0),
    (0, 9, 54, 40, 1.195, 123.403),
    (0, 36, 54, 36, 0.3, 113.943),
    (0, 0, 55, 0, 0.0, 120.8),
    ...
    (0, 36, 56, 36, 0.45, 117.534),
    (0, 36, 56, 37, 0.602, 120.0),
    (0, 36, 56, 57, 0.646, 120.649),
    (0, 36, 56, 63, 0.579, 123.766),
    (0, 36, 56, 80, 0.625, 120.0),
    ...
    (1, 9, 57, 55, 0.98, 128.143),
    (0, 12, 57, 55, 1.058, 118.327),
    (0, 15, 57, 55, 0.983, 123.646),
    (0, 25, 57, 55, 0.79, 122.889),
    (1, 37, 57, 55, 0.967, 121.379),
    (0, 55, 57, 55, 0.855, 126.476),
    (1, 55, 57, 63, 1.016, 118.8),
    (1, 55, 57, 64, 1.039, 117.166),
    (0, 56, 57, 56, 1.342, 120.01),
    (0, 0, 58, 0, 0.0, 119.0),
    (1, 0, 58, 0, 0.0, 119.9),
    (0, 1, 58, 37, 1.003, 119.236),
    (0, 1, 58, 64, 0.961, 121.07),
    (1, 3, 58, 37, 0.983, 121.506),
    (0, 6, 58, 37, 1.371, 114.37),
    (0, 18, 58, 37, 1.005, 120.665),
    (0, 36, 58, 37, 0.65, 118.713),
    (0, 36, 58, 63, 0.65, 118.0),
    (0, 36, 58, 64, 0.62, 120.051),
    (0, 37, 58, 37, 0.996, 122.71),
    (1, 37, 58, 37, 1.036, 118.26),
    (0, 37, 58, 63, 1.087, 116.989),
    (0, 37, 58, 64, 1.061, 117.942),
    (0, 0, 59, 0, 0.0, 105.6),
    (0, 63, 59, 63, 1.273, 106.313),
    (0, 63, 59, 65, 1.75, 107.755),
    ...
    (0, 0, 61, 0, 0.0, 180.0),
    (0, 1, 61, 60, 0.475, 180.0),
    (0, 37, 61, 42, 0.536, 180.0),
    (0, 37, 61, 60, 0.484, 180.0),
    (0, 0, 62, 0, 0.0, 108.3),
    ...
    (0, 5, 63, 78, 0.482, 130.0),
    (0, 5, 63, 81, 0.588, 124.0),
    ...
    (1, 37, 63, 66, 0.871, 128.13),
    (0, 38, 63, 39, 1.022, 124.814),
    (0, 38, 63, 64, 0.91, 126.513),
    (0, 39, 63, 39, 0.91, 131.461),
    ...
    (0, 64, 64, 65, 0.916, 113.57),
    (1, 64, 64, 66, 1.003, 118.067),
    (0, 64, 64, 78, 1.194, 103.479),
    (0, 64, 64, 82, 1.21, 108.553),
    (0, 65, 64, 66, 1.055, 115.369),
    (0, 65, 64, 81, 1.168, 116.24),
    (0, 66, 64, 66, 0.932, 129.624),
    (0, 0, 65, 0, 0.0, 104.5),
    (0, 39, 65, 64, 1.738, 101.55),
    (0, 39, 65, 66, 1.589, 106.36),
    (0, 39, 65, 82, 1.74, 101.208),
    (0, 44, 65, 64, 1.43, 103.829),
    ...
    (1, 37, 81, 80, 0.94, 123.333),
    (0, 63, 81, 64, 1.115, 114.945),
    (0, 64, 81, 65, 1.075, 122.099),
    (0, 64, 81, 80, 1.143, 113.176),
    (0, 66, 81, 80, 1.067, 122.25),
    (0, 78, 81, 80, 0.957, 110.556),
    (0, 79, 81, 80, 1.379, 107.936),
    (0, 32, 82, 59, 1.666, 114.66),
    (0, 32, 82, 64, 1.075, 131.706),
    (0, 32, 82, 65, 1.238, 129.293),
    (0, 59, 82, 64, 1.563, 105.66),
    (0, 64, 82, 65, 1.281, 112.955),
    // New atom types: CE4R(30), O_3P(49), H_OXP(50), S_O3(73), S_CSO(74), CL4(77), N_RAD(62)
    (0, 1, 49, 1, 1.370033, 111.400),
    (0, 1, 49, 50, 0.846634, 111.400),
    (0, 1, 73, 32, 1.590, 100.180),
    (0, 3, 74, 7, 1.357, 113.010),
    (0, 5, 1, 49, 0.781, 108.577),
    (0, 5, 1, 73, 0.633, 107.153),
    (0, 5, 3, 74, 0.595846, 117.300),
    (0, 5, 20, 30, 0.688, 116.038),
    ...
    (4, 20, 30, 30, 1.117, 95.513),
    // N_RAD (type 62)
    (0, 1, 62, 23, 0.725136, 108.300),
    (0, 5, 1, 62, 0.655, 113.035),
    // O_2P (furanium, type 51) angles
    (0, 5, 3, 51, 0.670, 123.439),
    (0, 5, 30, 51, 0.534829, 134.200),
    (4, 3, 51, 30, 1.853537, 90.000),
    (4, 30, 30, 51, 1.434933, 97.700),
    (7, 30, 3, 51, 1.630211, 91.100),
    // P_ARM (phosphirene, type 75) angles
    (0, 5, 3, 75, 0.450395, 117.300),
    (1, 5, 30, 75, 0.331019, 131.800),
    (7, 3, 75, 30, 1.127597, 90.000),
    (7, 30, 3, 75, 1.089072, 91.100),
    (7, 30, 30, 75, 1.024677, 92.300),
    // === val_set_new4 angle params ===
    // N_5OX (67) angles — pyridine N-oxide
    (0, 2, 67, 2, 0.964353, 120.0),
    (0, 2, 67, 7, 1.250581, 116.6),
    (0, 2, 2, 67, 1.132, 112.136),
    (0, 5, 2, 67, 0.643, 117.0),
    // N_IM (54) angles — iminium
    (0, 3, 54, 36, 0.685, 119.698),
    (0, 5, 3, 54, 0.816, 115.471),
    (0, 36, 54, 36, 0.300, 113.943),
    // N_SO (48) / S_O2 (18) angles — sulfinylamine
    (0, 1, 18, 32, 1.446, 107.066),
    (0, 1, 18, 48, 1.277, 106.586),
    (0, 1, 18, 71, 0.704330, 104.6),
    (0, 5, 1, 18, 0.663, 106.855),
    (0, 18, 48, 28, 0.736, 113.969),
    (0, 32, 18, 48, 1.229, 126.841),
    (0, 32, 18, 71, 0.991406, 104.6),
    (0, 48, 18, 71, 0.850129, 104.6),
    // C5A_M (78) / C_IM (80) / N_5POS (81) angles — imidazolium
    (0, 1, 81, 78, 0.879, 126.535),
    (0, 1, 81, 80, 0.895, 126.324),
    ...
    (0, 78, 81, 80, 0.957, 110.556),
    // N_GD (56) angles — guanidinium
    (0, 1, 56, 1, 0.964833, 119.1),
    // N_5OX (67) angles at correct angle_type (67 is sbmb=true)
    (1, 2, 67, 7, 1.250581, 116.6),
    (2, 2, 67, 2, 0.964353, 120.0),
    (1, 2, 2, 67, 1.132, 112.136),
    (1, 5, 2, 67, 0.643, 117.0),
    // N_5OX2 (82) angles — isoxazole N-oxide 5-ring
    (0, 5, 63, 82, 0.546189, 123.3),
    (0, 32, 82, 63, 1.228096, 120.0),
    (0, 63, 82, 64, 0.980514, 120.0),
    (0, 59, 63, 82, 1.120463, 123.3),
    // === val_set_new5 angles ===
    // O_2P (51) / H_OXP2 (52) angles
    (0, 3, 51, 52, 0.913, 111.360),
    (0, 5, 3, 51, 0.670, 123.439),
    (0, 11, 3, 51, 1.397288, 117.3),
    // N5 (79) angles — general 5-ring N
    (0, 5, 78, 79, 0.617, 122.0),
    (0, 36, 81, 79, 0.685150, 119.5),
    (0, 36, 81, 80, 0.575, 124.787),
    (0, 36, 81, 81, 0.641306, 119.5),
    (0, 78, 79, 81, 1.569, 102.043),
    (0, 79, 78, 81, 1.217, 114.792),
    (0, 79, 81, 80, 1.379, 107.936),
    (0, 79, 81, 81, 1.165425, 119.5),
    (0, 81, 80, 81, 1.205, 108.609),
    (0, 1, 81, 79, 1.144, 116.113),
    (0, 1, 81, 81, 1.043479, 119.5),
    (0, 5, 64, 79, 0.563419, 121.4),
    (0, 64, 79, 81, 1.431251, 103.4),
    (0, 79, 64, 79, 0.995927, 121.4),
    // O_2P (51) angles in furanium ring (C_AR-O+=-C_AR)
    (0, 1, 37, 51, 1.084671, 118.8),
    (0, 37, 37, 51, 1.129877, 118.8),
    (0, 37, 51, 37, 1.370033, 111.4),
];
...
pub const MMFF_STBN_TABLE: [(u8, u8, u8, u8, f64, f64); 309 + 1 + 5 + 13] = [
    ...
    (0, 18, 6, 33, 0.309, 0.12),
    (4, 20, 6, 20, 0.739, 0.739),
    (0, 29, 6, 37, 0.13, 0.241),
    ...
    (0, 5, 63, 64, 0.055, 0.37),
    (0, 5, 63, 66, 0.11, 0.464),
    ...
    // New types: CE4R(30), O_3P(49), H_OXP(50), S_O3(73)
    (0, 1, 49, 1, 0.3, 0.3),
    (0, 5, 1, 49, 0.1, 0.3),
    (0, 1, 49, 50, 0.3, 0.1),
    (0, 50, 49, 50, 0.072, 0.072),
    ...
    (10, 30, 30, 75, 0.5, 0.3),
    (0, 30, 30, 75, 0.3, 0.5),
    // C-P-C angle (central P=75)
    (9, 3, 75, 30, 0.3, 0.3),
    (0, 3, 75, 30, 0.3, 0.3),
    (10, 3, 75, 30, 0.3, 0.3),
    // N_GD (56) stretch-bend — guanidinium
    (0, 1, 56, 1, 0.3, 0.3),
    (0, 1, 3, 37, 0.217, 0.207),
    (0, 1, 15, 3, 0.3, 0.3),
    (0, 3, 1, 15, 0.3, 0.5),
    (0, 3, 37, 37, 0.179, 0.217),
    (0, 6, 18, 37, 0.3, 0.3),
    (0, 7, 3, 37, 0.707, 0.007),
    (0, 9, 3, 15, 0.3, 0.5),
    (0, 13, 37, 37, 0.5, 0.3),
    (0, 15, 1, 37, 0.5, 0.3),
    (0, 15, 3, 40, 0.5, 0.3),
...
#[rustfmt::skip]
pub const MMFF_DFSB_TABLE: [(u8, u8, u8, f64, f64); 30] = [
    (0, 1, 0, 0.15, 0.15),
    (0, 1, 1, 0.1, 0.3),
    (0, 1, 2, 0.05, 0.35),
    (0, 1, 3, 0.05, 0.35),
...
pub fn get_periodic_table_row(atomic_number: u8) -> u8 {
    match atomic_number {
        1 => 0,       // H - period 1
        6..=9 => 1,   // C, N, O, F - period 2
        14..=17 => 2, // Si, P, S, Cl - period 3
        35 => 3,      // Br - period 4
        53 => 4,      // I - period 5
        _ => 1,
    }
...
pub fn compute_angle_type(bond_type_ij: u8, bond_type_jk: u8, ring_size: u8) -> u8 {
    let bond_type_sum = bond_type_ij + bond_type_jk;
    let mut angle_type = bond_type_sum;
    if ring_size == 3 || ring_size == 4 {
        angle_type = ring_size;
        if bond_type_sum > 0 {
            angle_type += bond_type_sum + ring_size - 2;
        }
    }
    angle_type
}
...
pub fn compute_stretch_bend_type(angle_type: u8, bond_type_1: u8, bond_type_2: u8) -> u8 {
    match angle_type {
        1 => {
            if bond_type_1 != 0 || bond_type_1 == bond_type_2 {
                1
            } else {
                2
            }
...
pub fn lookup_angle_params(
    ...
    let mut iter = 0;
    while iter < 4 {
        let idx_i = type_i as usize;
        let idx_k = type_k as usize;
...
pub fn lookup_stbn_only(type_i: u8, type_j: u8, type_k: u8, sb_type: u8) -> Option<(f64, f64)> {
    ...
    for &(st, ti, tj, tk, kba_ijk, kba_kji) in MMFF_STBN_TABLE.iter() {
        if st == sb_type && ti == can_i && tj == type_j && tk == can_k {
            if swap {
...
#[rustfmt::skip]
pub const MMFF_PROP_TABLE: [(u8, u8, u8, u8, u8, u8, u8, u8); 100] = [
    (0, 0, 0, 0, 0, 0, 0, 0),  // type 0
    (6, 4, 4, 0, 0, 0, 0, 0),  // type 1
    (6, 3, 4, 0, 2, 0, 0, 1),  // type 2
    (6, 3, 4, 0, 2, 0, 0, 1),  // type 3
    (6, 2, 4, 0, 3, 0, 1, 1),  // type 4
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 5
    (8, 2, 2, 1, 0, 0, 0, 0),  // type 6
    (8, 1, 2, 0, 2, 0, 0, 0),  // type 7
    (7, 3, 3, 1, 0, 0, 0, 0),  // type 8
    (7, 2, 3, 0, 2, 0, 0, 1),  // type 9
    (7, 3, 3, 1, 1, 0, 0, 0),  // type 10
    (9, 1, 1, 1, 0, 0, 0, 0),  // type 11
    (17, 1, 1, 1, 0, 0, 0, 0),  // type 12
    (35, 1, 1, 1, 0, 0, 0, 0),  // type 13
    (53, 1, 1, 1, 0, 0, 0, 0),  // type 14
    (16, 2, 2, 1, 0, 0, 0, 0),  // type 15
    (16, 1, 2, 0, 2, 0, 0, 0),  // type 16
    (16, 3, 4, 0, 2, 0, 0, 0),  // type 17
    (16, 4, 4, 0, 0, 0, 0, 0),  // type 18
    (14, 4, 4, 0, 0, 0, 0, 0),  // type 19
    (6, 4, 4, 0, 0, 0, 0, 0),  // type 20
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 21
    (6, 4, 4, 0, 0, 0, 0, 0),  // type 22
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 23
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 24
    (15, 4, 4, 0, 0, 0, 0, 0),  // type 25
    (15, 3, 3, 1, 0, 0, 0, 0),  // type 26
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 27
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 28
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 29
    (6, 3, 4, 0, 2, 0, 0, 1),  // type 30
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 31
    (8, 1, 12, 1, 1, 0, 0, 0),  // type 32
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 33
    (7, 4, 4, 0, 0, 0, 0, 0),  // type 34
    (8, 1, 1, 1, 1, 0, 0, 0),  // type 35
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 36
    (6, 3, 4, 0, 2, 1, 0, 1),  // type 37
    (7, 2, 3, 0, 2, 1, 0, 0),  // type 38
    (7, 3, 3, 1, 1, 1, 0, 1),  // type 39
    (7, 3, 3, 1, 0, 0, 0, 0),  // type 40
    (6, 3, 4, 0, 1, 0, 0, 0),  // type 41
    (7, 1, 3, 0, 3, 0, 0, 0),  // type 42
    (7, 3, 3, 1, 0, 0, 0, 0),  // type 43
    (16, 2, 2, 1, 1, 1, 0, 0),  // type 44
    (7, 3, 4, 0, 2, 0, 0, 0),  // type 45
    (7, 2, 3, 0, 2, 0, 0, 0),  // type 46
    (7, 1, 2, 0, 2, 0, 0, 0),  // type 47
    (7, 2, 2, 0, 0, 0, 0, 0),  // type 48
    (8, 3, 3, 0, 0, 0, 0, 0),  // type 49
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 50
    (8, 2, 3, 0, 2, 0, 0, 0),  // type 51
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 52
    (7, 2, 4, 0, 2, 0, 1, 0),  // type 53
    (7, 3, 4, 0, 2, 0, 0, 1),  // type 54
    (7, 3, 34, 0, 1, 0, 0, 0),  // type 55
    (7, 3, 34, 0, 1, 0, 0, 0),  // type 56
    (6, 3, 4, 0, 2, 0, 0, 1),  // type 57
    (7, 3, 4, 0, 1, 1, 0, 1),  // type 58
    (8, 2, 2, 1, 1, 1, 0, 0),  // type 59
    (6, 1, 3, 0, 3, 0, 0, 0),  // type 60
    (7, 2, 4, 0, 3, 0, 1, 0),  // type 61
    (7, 2, 2, 1, 0, 0, 0, 0),  // type 62
    (6, 3, 4, 0, 2, 1, 0, 1),  // type 63
    (6, 3, 4, 0, 2, 1, 0, 1),  // type 64
    (7, 2, 3, 0, 2, 1, 0, 0),  // type 65
    (7, 2, 3, 0, 2, 1, 0, 0),  // type 66
    (7, 3, 4, 0, 2, 0, 0, 1),  // type 67
    (7, 4, 4, 0, 0, 0, 0, 0),  // type 68
    (7, 3, 4, 0, 1, 1, 0, 0),  // type 69
    (8, 2, 2, 1, 0, 0, 0, 0),  // type 70
    (1, 1, 1, 0, 0, 0, 0, 0),  // type 71
    (16, 1, 1, 1, 1, 0, 0, 0),  // type 72
    (16, 3, 3, 0, 0, 0, 0, 0),  // type 73
    (16, 2, 4, 0, 2, 0, 0, 0),  // type 74
    (15, 2, 3, 0, 2, 0, 0, 1),  // type 75
    (7, 2, 2, 1, 0, 0, 0, 0),  // type 76
    (17, 4, 4, 0, 0, 0, 0, 0),  // type 77
    (6, 3, 4, 0, 2, 1, 0, 1),  // type 78
    (7, 2, 3, 0, 2, 1, 0, 0),  // type 79
    (6, 3, 4, 0, 2, 0, 0, 1),  // type 80
    (7, 3, 4, 0, 1, 1, 0, 1),  // type 81
    (7, 3, 4, 0, 1, 1, 0, 0),  // type 82
    (0, 0, 0, 0, 0, 0, 0, 0),  // type 83 (unused)
    (0, 0, 0, 0, 0, 0, 0, 0),  // type 84 (unused)
    (0, 0, 0, 0, 0, 0, 0, 0),  // type 85 (unused)
    (0, 0, 0, 0, 0, 0, 0, 0),  // type 86 (unused)
    (26, 0, 0, 0, 0, 0, 0, 0),  // type 87
    (26, 0, 0, 0, 0, 0, 0, 0),  // type 88
    (9, 0, 0, 0, 0, 0, 0, 0),  // type 89
    (17, 0, 0, 0, 0, 0, 0, 0),  // type 90
    (35, 0, 0, 0, 0, 0, 0, 0),  // type 91
    (3, 0, 0, 0, 0, 0, 0, 0),  // type 92
    (11, 0, 0, 0, 0, 0, 0, 0),  // type 93
    (19, 0, 0, 0, 0, 0, 0, 0),  // type 94
    (30, 0, 0, 0, 0, 0, 0, 0),  // type 95
    (20, 0, 0, 0, 0, 0, 0, 0),  // type 96
    (29, 0, 0, 0, 0, 0, 0, 0),  // type 97
    (29, 0, 0, 0, 0, 0, 0, 0),  // type 98
    (12, 0, 0, 0, 0, 0, 0, 0),  // type 99
];

pub fn get_mmff_prop(type_id: u8) -> Option<(u8, u8, u8, u8, u8, u8, u8, u8)> {
...
pub fn empirical_angle_params(
    ...
    let mut z = [0.0f64; 3];
    let mut c = [0.0f64; 3];
    let atomic_nums = [atno_i, atno_j, atno_k];
    for i in 0..3 {
        match atomic_nums[i] {
            1 => z[i] = 1.395,
            6 => {
    ...
    let theta0_rad = theta0 * std::f64::consts::PI / 180.0;

    let ka =
        beta * z[0] * c[1] * z[2] / ((r0_ij + r0_jk) * theta0_rad * theta0_rad * (2.0 * d).exp());
